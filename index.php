...
<html>
<head>
<title>Klinik Sumber Rahman</title>
...
<body>
<h1>Login Klinik Sumber Rahman</h1>
<div class="log">

  <div class="content1 agileits">
    <h2>Sign In</h2>
    <form action="cek_login.php" method="POST">
       <input type="text" name="user" class="placeholder" placeholder="Username">
...
<div class="footer">
  <p>© 2017 Klinik Sumber Rahman | Design by <a href="https://w3layouts.com/" target="_blank">w3layouts</a></p>
</div>
